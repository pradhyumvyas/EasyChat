...
function App() {
  ...
  const sideNav = () => {
    return (
      <aside className="flex flex-col items-center w-16 h-screen py-8 overflow-y-auto bg-gray border-r dark:bg-gray-900 dark:border-gray-700">
  ...
  return (
    <div className='EasyChat'>
      {sideNav()}
      <div className="App">
        <h1 className="text-3xl font-bold py-3 heading">Easy Chat</h1>
        <div className={chat.length > 0 ? 'chatWindow' : ''}>
